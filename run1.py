...
async def analysis_loop(monitored_symbols_ref: dict):
    # ... Vòng lặp analysis của bạn giữ nguyên như cũ ...

async def signal_check_loop(notifier: NotificationHandler):
    # ... Vòng lặp signal_check với chức năng gửi thông báo hàng loạt (batching) giữ nguyên như cũ ...
...
async def main():
    ...
    # ... (Code gửi tin nhắn khởi động của bạn) ...
